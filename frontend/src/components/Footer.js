...
function Footer() {
  return (
    <>
      <div className="container-fluid bg-dark text-secondary mt-5 pt-5">
        <div className="row px-xl-5 pt-5">
          <div className="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            ...
            <p className="mb-2">
              <i className="fa fa-map-marker-alt text-primary mr-3"></i>1 Vo Van
            ...
            <p className="mb-0">
              <i className="fa fa-phone-alt text-primary mr-3"></i>0356034540
            </p>
          </div>
      ...
      <Link href="#" className="btn btn-primary back-to-top">
